...
(function (factory) {
  ...
  var Renderer = function () {
    ...
    /* jshint ignore:start */
    tplToolbarInfo = {
    	      samples: function (lang) {
    	          return '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.font.bold + '" data-shortcut="Ctrl+S" data-mac-shortcut="⌘+S"  data-toggle="modal" data-target="#samplesModal" tabindex="-1">Samples</button>';
    	        },
